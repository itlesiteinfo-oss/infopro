...
$hprnb_has_toggle   = in_array( $hprnb_ticker, array( 'marquee', 'rotate' ), true );
$hprnb_has_manual   = ( 'manual' === $hprnb_ticker );
$hprnb_has_close    = ! empty( $hprnb_settings['close_button'] );
$hprnb_has_controls = $hprnb_has_toggle || $hprnb_has_manual || $hprnb_has_close;
?>
<aside class="<?php echo esc_attr( implode( ' ', $hprnb_classes ) ); ?>" role="region" aria-label="<?php esc_attr_e( 'Latest news', 'horizon-press-news-bar' ); ?>" aria-live="off" dir="auto" data-hprnb-ticker="<?php echo esc_attr( $hprnb_ticker ); ?>" data-hprnb-speed="<?php echo (int) $hprnb_settings['ticker_speed']; ?>" data-hprnb-interval="<?php echo (int) $hprnb_settings['rotate_interval']; ?>" data-hprnb-hover="<?php echo empty( $hprnb_settings['pause_on_hover'] ) ? '0' : '1'; ?>" data-hprnb-remember="<?php echo empty( $hprnb_settings['remember_dismiss'] ) ? '0' : '1'; ?>" data-hprnb-dismiss-hours="<?php echo (int) $hprnb_settings['dismiss_duration_hours']; ?>" data-hprnb-reltime="<?php echo empty( $hprnb_settings['show_relative_time'] ) ? '0' : '1'; ?>" data-hprnb-reltime-max="<?php echo (int) $hprnb_settings['relative_time_max_hours']; ?>">
	<div class="hprnb-bar__inner">
		...
		?>
		<?php if ( '' !== (string) $hprnb_settings['label_text'] ) : ?>
		<p class="hprnb-bar__label"><span class="hprnb-bar__label-text"><?php echo esc_html( $hprnb_settings['label_text'] ); ?></span></p>
		<?php endif; ?>
