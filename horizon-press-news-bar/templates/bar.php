...
?>
<aside class="<?php echo esc_attr( implode( ' ', $hprnb_classes ) ); ?>" role="region" aria-label="<?php esc_attr_e( 'Latest news', 'horizon-press-news-bar' ); ?>" aria-live="off" dir="auto" data-hprnb-ticker="<?php echo esc_attr( $hprnb_ticker ); ?>" data-hprnb-ticker-mobile="<?php echo esc_attr( $hprnb_mobile ); ?>" data-hprnb-speed="<?php echo (int) $hprnb_settings['ticker_speed']; ?>" data-hprnb-interval="<?php echo (int) $hprnb_settings['rotate_interval']; ?>" data-hprnb-hover="<?php echo empty( $hprnb_settings['pause_on_hover'] ) ? '0' : '1'; ?>" data-hprnb-remember="<?php echo empty( $hprnb_settings['remember_dismiss'] ) ? '0' : '1'; ?>" data-hprnb-dismiss-hours="<?php echo (int) $hprnb_settings['dismiss_duration_hours']; ?>" data-hprnb-reltime="<?php echo empty( $hprnb_settings['show_relative_time'] ) ? '0' : '1'; ?>" data-hprnb-reltime-max="<?php echo (int) $hprnb_settings['relative_time_max_hours']; ?>">
